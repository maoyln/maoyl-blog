...
module.exports = {
  ...
  repo: 'maoyln/maoyl-blog', // 导航栏右侧生成Github链接
  ...
  bodyBgImg: [
    ...
    `https://cdn.jsdelivr.net/gh/maoyln/maoyl-img/blog/10511463W5s.jpeg`,
  ...
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: 'https://cdn.jsdelivr.net/gh/maoyln/maoyl-img/blog/my-head.jpeg',
    name: 'maoyln',
    slogan: '日日行，不怕千万里',
  },
  social: {
  ...
  footer: {
    ...
    copyrightInfo:
      ...
      // `京ICP备19058102号<a href="https://github.com/maoyln/maoyl-blog/blob/master/LICENSE" target="_blank">MIT License1</a>'` // 博客版权信息，支持a标签
  },
